...
# libsqlite3-dev 提供了 SQLite 的開發庫，確保 pysqlite3 等相關套件能正確編譯。
# python3-dev 包含了 Python 的開發頭文件，對於編譯依賴 Python C API 的套件至關重要。
...
# STEP 4: 安裝 'wheel' 套件
# 在安裝主要依賴之前先安裝 'wheel'，可以幫助 pip 正確地建置和安裝一些複雜的 Python 套件。
RUN pip install --no-cache-dir wheel

# STEP 5: 複製 requirements.txt 並安裝所有 Python 依賴
